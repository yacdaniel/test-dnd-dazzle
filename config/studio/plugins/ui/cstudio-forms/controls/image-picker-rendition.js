CStudioForms.Controls.ImagePickerRendition = CStudioForms.Controls.ImagePickerRendition ||
...
YAHOO.extend(CStudioForms.Controls.ImagePickerRendition, CStudioForms.CStudioFormField, {


    getLabel: function() {
        return CMgs.format(langBundle, "image-rendition");
    },
...
//            else {
                        ...
                        if (!valid) {
                            ...
                            function imageLoaded(){
                                ...
                                if (!valid) {
                                    ...
                                    YConnect.asyncRequest('GET', transformService, transformCb);
    ...
    render: function(config, containerEl) {
        ...
        for(var i=0; i<config.properties.length; i++) {
            ...
            if(prop.name == "renditions") {
                if(prop.value && prop.value != "") {
                    this.renditions = prop.value.split(",");
                }
            }
    ...
    getSupportedProperties: function() {
        return [
            ...
            { label: CMgs.format(langBundle, "renditions"), name: "renditions", type: "string" },
...
CStudioAuthoring.Module.moduleLoaded("cstudio-forms-controls-image-picker-rendition", CStudioForms.Controls.ImagePickerRendition);
